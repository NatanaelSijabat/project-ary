...
export default function Authenticated({ auth, children, npwpd, header }) {
    ...
    return (
        ...
        <div className="min-h-screen">
            <ExampleNavbar auth={auth.user.name} npwpd={auth.user.npwpd} />
            <ExampleSidebar />
            {header && (
                <header className="bg-gray-300 shadow pt-20 sm:ml-64">
